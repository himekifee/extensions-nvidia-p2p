...
EXPECTED = {
    "targetTalosVersion": "v1.12.6",
    "targetTalosMinor": "v1.12",
    "kubernetesVersion": "v1.32.5",
    "kubernetesMinor": "v1.32",
    "arch": "amd64",
    "osImage": "Talos (v1.12.6)",
    "selectedTrack": "lts",
    "upstreamTag": "580.105.08",
    "upstreamRepository": "https://github.com/NVIDIA/open-gpu-kernel-modules",
    "upstreamReleaseURL": "https://github.com/NVIDIA/open-gpu-kernel-modules/releases/tag/580.105.08",
    "upstreamCommit": "2af9f1f0f7de4988432d4ae875b5858ffdb09cc2",
    "donorRepository": "https://github.com/aikitoria/open-gpu-kernel-modules",
    "donorBranch": "580.105.08-p2p",
    "donorBaseRelease": "580.105.08",
    "donorBaseCommit": "2af9f1f0f7de4988432d4ae875b5858ffdb09cc2",
    "donorPatchCommit": "510a7720de1e7fa3ef374a721b48f700b23895b9",
    "donorBranchHeadCommit": "7e392c1e0b8e2e8e82958d9d17ba3a0721551a2a",
    "donorCompareDiffURL": "https://github.com/aikitoria/open-gpu-kernel-modules/compare/2af9f1f0f7de4988432d4ae875b5858ffdb09cc2...510a7720de1e7fa3ef374a721b48f700b23895b9.diff",
    "openModuleName": "siderolabs/nvidia-open-gpu-kernel-modules-lts",
    "openModuleRef": "ghcr.io/siderolabs/nvidia-open-gpu-kernel-modules-lts:580.105.08-v1.12.0",
    "openModuleDigest": "sha256:aa769308b09815c604d4f445357256762c6ecfea60e5b902320193326f4a37af",
    "toolkitName": "siderolabs/nvidia-container-toolkit-lts",
    "toolkitRef": "ghcr.io/siderolabs/nvidia-container-toolkit-lts:580.105.08-v1.18.1",
    "toolkitDigest": "sha256:3c367715634984f4e4299f38897b5aca4e46bf1430996b49c3829733b0497d7c",
    "toolkitTrack": "lts",
    "toolkitDriverFamilyBranch": "580",
        ...
        if lineage:
            ...
            if "donor patch" not in lineage_lower or EXPECTED["upstreamTag"] not in lineage:
                errors.append(
                    ...
                    f"NVIDIA {EXPECTED['upstreamTag']} LTS base"
                )
...
print(f"validated NVIDIA LTS tag: {document['nvidia']['upstreamOpenModuleTag']}")
